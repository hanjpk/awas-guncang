...
class DemoGuncangan extends StatefulWidget {
  const DemoGuncangan({super.key});

  @override
  State<DemoGuncangan> createState() => _DemoGuncanganState();
}

class _DemoGuncanganState extends State<DemoGuncangan> {
  ...
  void initState() {
    super.initState();
    playSound();
    startColorBlinking(); // Start the blinking effect
  }

  void startColorBlinking() {
    colorTimer = Timer.periodic(const Duration(milliseconds: 500), (timer) {
      setState(() {
        scaffoldColor =
            ...
            child: Container(
              ...
              child: const Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10),
                  Text(
                    "Anda telah menekan fitur demo peringatan dini gempa bumi. Jangan putar ini di publik.",
                    style: TextStyle(
                      fontSize: 16,
                      color: Colors.white,
                    ),
